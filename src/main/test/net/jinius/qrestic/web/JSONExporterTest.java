...
public class JSONExporterTest {
    ...
    public void testExportJobs() throws IOException {
        ...
        jsonExporter.setFlushInterval(50);
        jsonExporter.setDataSource(dataSource);
        ...
        jsonExporter.addConfig(new ExportConfig("Jobs", "select * from job", ch));
        log.info("Exporting Jobs");
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        jsonExporter.exportTo(bos);
